...

{
	...
	drawInfo.numberOfVertices = theMesh.vVert_Norms.size();
	...
	{
		drawInfo.pVertices[index].x = theMesh.vVert_Norms[index].x;
		drawInfo.pVertices[index].y = theMesh.vVert_Norms[index].y;
		drawInfo.pVertices[index].z = theMesh.vVert_Norms[index].z;
		drawInfo.pVertices[index].w = 1.0f;

		drawInfo.pVertices[index].nx = theMesh.vVert_Norms[index].nx;
		drawInfo.pVertices[index].ny = theMesh.vVert_Norms[index].ny;
		drawInfo.pVertices[index].nz = theMesh.vVert_Norms[index].nz;
	...
	drawInfo.numberOfTriangles = theMesh.vTri_Index.size();
	drawInfo.numberOfIndices = theMesh.vTri_Index.size() * 3;
	...
	{
		drawInfo.pIndices[indexIndex + 0] = theMesh.vTri_Index[indexTri].index_1;
		drawInfo.pIndices[indexIndex + 1] = theMesh.vTri_Index[indexTri].index_2;
		drawInfo.pIndices[indexIndex + 2] = theMesh.vTri_Index[indexTri].index_3;
	}
...
//	glBindBuffer(GL_ARRAY_BUFFER, vertex_buffer);
	...
	GLint vNormal = glGetAttribLocation(shaderProgramID, "vNormal");
	...
	glVertexAttribPointer(vNormal, 4,
		GL_FLOAT, GL_FALSE,
		sizeof(sVertex),
